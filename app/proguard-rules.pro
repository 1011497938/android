...
-keep class cn.edu.zju.qcw.android.push.ImMessageReceiver {*;}
...
-keep class cn.edu.zju.qcw.android.common.event.** {*;}
...
# 将下面替换成自己的实体类
-keep public class * extends cn.edu.zju.qcw.android.base.BaseBean {*;}
-keep class cn.edu.zju.qcw.android.base.BaseBean { *;}
-keep class cn.edu.zju.qcw.android.common.bean.** { *; }
-keep class cn.edu.zju.qcw.android.common.entity.** { *; }
-keep class **Bean{*;}
-keep class **Entity{*;}
