...
import com.chad.library.adapter.base.LoadingStrUtil;
...
public abstract class LoadMoreView {
    ...
    private void visibleLoading(BaseViewHolder holder, boolean visible) {
        ...
        LoadingText.setText(LoadingStrUtil.getZjuStr());
        holder.setVisible(getLoadingViewId(), visible);
    }

    private void visibleLoadFail(BaseViewHolder holder, boolean visible) {
        TextView LoadingText = holder.getView(R.id.tv_prompt);
        LoadingText.setText(LoadingStrUtil.genUnhappyFace() + " 加载失败，点击重试");
        holder.setVisible(getLoadFailViewId(), visible);
    }

    private void visibleLoadEnd(BaseViewHolder holder, boolean visible) {
        TextView LoadingText = holder.getView(R.id.noMore);
        LoadingText.setText(LoadingStrUtil.genHappyFace() + " 没有更多内容了");
